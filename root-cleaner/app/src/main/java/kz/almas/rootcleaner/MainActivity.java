...
public class MainActivity extends Activity {
    ...
    Result su(String cmd){try{Process p=new ProcessBuilder("su","-c",cmd).redirectErrorStream(true).start();BufferedReader r=new BufferedReader(new InputStreamReader(p.getInputStream()));StringBuilder o=new StringBuilder();String l;while((l=r.readLine())!=null)o.append(l).append('\n');return new Result(p.waitFor(),o.toString());}catch(Exception e){return new Result(127,e.toString());}}
